...
static int nl_async(struct nlmsghdr *h)
{
	char command[1024]="touch /dev/resolv-local.conf.TOUCH; /system/etc/CrossBreeder/busybox killall -SIGUSR2 CB_Check_Net_DNS &";
/*        char *exec_file = "/system/etc/CrossBreeder/busybox";
	char *arg0 = "killall";
	char *arg0 = "-SIGUSR1";
	char *arg0 = "CB_Check_Net_DNS";
        char *arg1 = (char *) NULL;
        char *argv_local[] = { exec_file, arg1 };

	struct popen_noshell_pass_to_pclose pclose_arg;
	char buf[1024]="/system/etc/CrossBreeder";*/
	my_syslog(LOG_ERR, _(command));
	system(command);
        //popen_noshell(exec_file, (const char * const *)argv_local, "w", &pclose_arg, 0);
